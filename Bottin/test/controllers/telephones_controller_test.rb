...
class TelephonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telephone" do
    assert_difference('Telephone.count') do
      post telephones_url, params: { telephone: { belongs_to: @telephone.belongs_to, email: @telephone.email, phonenumber: @telephone.phonenumber } }
    end
  ...
  test "should update telephone" do
    patch telephone_url(@telephone), params: { telephone: { belongs_to: @telephone.belongs_to, email: @telephone.email, phonenumber: @telephone.phonenumber } }
