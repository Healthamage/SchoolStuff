class TelephonesController < ApplicationController
  ...
  before_action :set_all_contacts, only: [:edit, :new, :update ,:create]
  # GET /telephones
  # GET /telephones.json
  def index
  ...
  def new
    ...
    @telephone.contact = Contact.find(params[:contact_id])
  end
  ...
  private
    ...
    def telephone_params
      params.require(:telephone).permit(:phonenumber, :email, :contact_id)
    end
